...
|---|---|---|
| **Extraktionshelfer** | jeden n-ten Buchstaben, Indexliste („3,1,4"), aus jedem Wort, Gitter zeilen-/spalten-/diagonal lesen, ein Zeichen zählen – der Schlussschritt fast jedes Rätsels | S |
